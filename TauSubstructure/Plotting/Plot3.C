...
double legx1 = 0.32;
double legy1= 0.93;
double label_x = kStack ? 0.7 : 0.4;
double label_y = 0.87;
double label_dy = 0.05;
int histo_lw = 2;
string outputformat = "png";
string dir = "plots/plots_12_03/";
...
void Plot3(){
  ...
  p.file="user.zenon.TauPi0Rec_D3PD.147818.Pythia8_AU2CTEQ6L1_Ztautau.pTt10r15.v11.140320114926.merge/user.zenon.015244._00020.merge.tau4mom.root"; p.eta = "#eta inclusive"; p.plot = "eta_incl";
...
TCanvas *C(){
  ...
  TCanvas *c = kStack ? new TCanvas(name.c_str(), "", 10,50,1100,500) :  new TCanvas(name.c_str(), "", 0,0, 800, 800);
  //c->Range(0,0,1,1);
  gStyle->SetOptStat(0);
